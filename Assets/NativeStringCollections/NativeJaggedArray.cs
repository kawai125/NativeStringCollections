...
namespace NativeStringCollections
{
        ...
        where T : unmanaged, IEquatable<T>
    {
        ...
        {
            var elem_index = this._elemIndexList[index];
            return new string((char*)this._buff.GetUnsafeReadOnlyPtr(), elem_index.Start, elem_index.Length);
        }
        ...
        public void Add(IEnumerable<T> str)
        {
            ...
            this._elemIndexList.Add(new ElemIndex(start, len));
        ...
        public unsafe int IndexOf(IEnumerable<T> key)
        {
