...
namespace NativeStringCollections.Impl.csFastFloat.Constants
{
    ...
    internal static class ConstStringArray
    {
        internal static readonly UInt16[] nan = new UInt16[] { 'n', 'a', 'n' };
        internal static readonly UInt16[] inf = new UInt16[] { 'i', 'n', 'f' };

        internal static readonly UInt16[] infinity = new UInt16[] { 'i', 'n', 'f', 'i', 'n', 'i', 't', 'y' };

        internal static readonly UInt16[] plus_nan = new UInt16[] { '+', 'n', 'a', 'n' };
        internal static readonly UInt16[] minus_nan = new UInt16[] { '-', 'n', 'a', 'n' };

        internal static readonly UInt16[] plus_inf = new UInt16[] { '+', 'i', 'n', 'f' };
        internal static readonly UInt16[] minus_inf = new UInt16[] { '-', 'i', 'n', 'f' };
    }
...

    {
        ...
        internal const int decimal_point_range = 2047;
        ...
        internal static byte get_powers(uint n)
        {
            ...
            CheckIndexForGetPowers(n);
            return powersTable[n];
        }

        [Conditional("ENABLE_UNITY_COLLECTIONS_CHECKS")]
        private static void CheckIndexForGetPowers(uint n)
        {
            if(n >= powersTable.Length)
                throw new ArgumentOutOfRangeException($"n = {n} is out of range. range: [0, {powersTable.Length-1}]");
        }

        private static readonly byte[] powersTable = new byte[19] {
